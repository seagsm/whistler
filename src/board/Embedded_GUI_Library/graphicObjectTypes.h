...
/**
  * @brief  bool enumeration definition
  */
typedef enum
{
   FALSE = 0,
...
struct GL_PageControlsObj
{
  ...
  GL_ObjType             objType;
  ErrorStatus           (*SetObjVisible)(GL_PageControls_TypeDef* pThis, GL_Coordinate_TypeDef objCoordinates);
};
...
struct GL_PageObj
{
  ...
  ErrorStatus             (*SetPage)(GL_Page_TypeDef* pThis, bool bVal);
