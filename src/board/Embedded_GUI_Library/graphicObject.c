...
static ErrorStatus Create_Label (GL_Label_TypeDef* );
static ErrorStatus Create_Button (GL_Button_TypeDef* );
static ErrorStatus Create_RadioButtonGrp (GL_RadioButtonGrp_TypeDef* );
static ErrorStatus Create_RadioButtonOption (GL_RadioOption_TypeDef* );
static ErrorStatus Create_ComboBoxGrp (GL_ComboBoxGrp_TypeDef* );
static ErrorStatus Create_ComboBoxOption (GL_ComboOption_TypeDef* );
static ErrorStatus Create_Checkbox (GL_Checkbox_TypeDef* );
static ErrorStatus Create_Switch (GL_Switch_TypeDef* );
static ErrorStatus Create_Icon (GL_Icon_TypeDef* );
static ErrorStatus Create_Slidebar (GL_Slidebar_TypeDef* );
static ErrorStatus Create_Histogram (GL_Histogram_TypeDef* );
static ErrorStatus Create_GraphChart (GL_GraphChart_TypeDef* );

static ErrorStatus SetLabelVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetCheckboxVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetSwitchVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetButtonVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetRadioButtonVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetComboBoxVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetIconVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetSlidebarVisible(GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetHistogramVisible( GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );
static ErrorStatus SetGraphChartVisible( GL_PageControls_TypeDef* , GL_Coordinate_TypeDef );

static void SlidebarCursorPreDraw(GL_PageControls_TypeDef* pControl, bool);
...
static ErrorStatus SetPage(GL_Page_TypeDef* pThis, bool bVal);
...
void GL_DrawButtonBMP(uint16_t maxX, uint16_t minX, uint16_t maxY, uint16_t minY, uint8_t* ptrBitmap)
{
  ...
  GL_SetDisplayWindow(0, 0, LCD_Height, LCD_Width);
}
...
GL_PageControls_TypeDef* AddRadioOption (GL_RadioButtonGrp_TypeDef* pThis, const uint8_t* label, void (*pEventHandler)(void))
{
  ...
  if (pOptionObj)
  {
    ...
    if ( pPageControlObj )
    {
      ...
      {
        ((GL_RadioOption_TypeDef*)(pThis->RadioOptions[0]->objPTR))->IsChecked = TRUE;
      }
...
/**
  ...
  * @param  pEventHandler: pointer to function associated to its touch event
  * @retval SUCCESS if successful, ERROR otherwise
  */
ErrorStatus AddComboOption (GL_ComboBoxGrp_TypeDef* pThis, const uint8_t* label, void (*pEventHandler)(void))
{
  ...
  if (pOptionObj)
  {
    ...
    {
      ((GL_ComboOption_TypeDef*)(pThis->ComboOptions[0]))->IsActive = TRUE;
    }
  }
...
/**
  ...
  * @retval GL_PageControls_TypeDef* - The created Object pointer
  */
GL_PageControls_TypeDef* NewGraphChart ( uint16_t ID, const uint8_t* labelX, const uint8_t* labelY, int16_t data_points[], uint8_t n_points, bool Background )
{
  GL_PageControls_TypeDef *pPageControlObj = NULL;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus AddPageControlObj (uint16_t PosX, uint16_t PosY, GL_PageControls_TypeDef* objPTR, GL_Page_TypeDef* pagePTR)
{
  if (pagePTR->ControlCount < MAX_CTRL_X_PAGE)
  {
    ...
    else if (objPTR->objType == GL_COMBOBOX)
    {
      ...
      if ( pTmpComboBoxGrp1->Secondary == FALSE)
      {
        ...
        pTmpComboBoxGrp->Secondary = TRUE;
#ifndef USE_2D_OBJECTS
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus Set_Label( GL_Page_TypeDef* pPage, uint16_t ID, const uint8_t* label )
{
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus Get_Label ( GL_Page_TypeDef* pPage, uint16_t ID, uint8_t* label )
{
  GL_Label_TypeDef* pTmp;
  uint32_t index = 0;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Label (GL_Label_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
  }
  pThis->Control_Visible = TRUE;
  return SUCCESS;
}
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Button (GL_Button_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
  }
  pThis->isObjectTouched = FALSE;
  pThis->Control_Visible = TRUE;
  return SUCCESS;
}
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_RadioButtonGrp (GL_RadioButtonGrp_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_RadioButtonOption (GL_RadioOption_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_ComboBoxGrp (GL_ComboBoxGrp_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_ComboBoxOption (GL_ComboOption_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Checkbox (GL_Checkbox_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Slidebar (GL_Slidebar_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Switch (GL_Switch_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Icon (GL_Icon_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_Histogram (GL_Histogram_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus Create_GraphChart (GL_GraphChart_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus Create_PageObj (GL_Page_TypeDef* pThis)
{
  if (!pThis)
  {
    return ERROR;
  ...
  {
    pThis->Page_Active       = FALSE;
    pThis->Page_Visible      = FALSE;
    /* Assign member functions */
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus DestroyPageControl ( GL_Page_TypeDef* pPage, uint16_t ID )
{
  uint32_t index = 0;
  if (!&pPage)
  {
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus DestroyPage (GL_Page_TypeDef * pPage)
{
  int32_t index = 0;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetLabelVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetButtonVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
  ...
  if (pThis->isObjectTouched == FALSE)
  {
#ifndef USE_2D_OBJECTS
  ...
  else if (pThis->isObjectTouched == TRUE)
  {
#ifndef USE_2D_OBJECTS
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetSwitchVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetRadioButtonVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
#ifndef USE_2D_OBJECTS
  uint8_t* ptrBitmap;
#endif
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetComboBoxVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
#ifndef USE_2D_OBJECTS
  uint8_t* ptrBitmap;
#endif
  ...
  if (pThis->Secondary == FALSE)
  {
#ifdef USE_2D_OBJECTS
    GL_SetFont(GL_FONT_BIG);
    GL_SetTextColor(GL_Black);
    GL_DisplayAdjStringLine( (uint8_t)(objCoordinates.MinY-1), (uint16_t)(objCoordinates.MaxX-1), "-", TRUE);
    GL_DisplayAdjStringLine( (uint8_t)(objCoordinates.MinY-1), (uint16_t)(objCoordinates.MaxX-4), "-", TRUE);
#endif
    for (; index < pThis->ComboOptionCount && pThis->ComboOptions[index]->IsActive == FALSE; index++)
    {}
    ...
    if(pThis->ComboOptionCount>0)
    {
      GL_DisplayAdjStringLine( (uint8_t)(objCoordinates.MaxY - 16),
                               ...
                               (uint8_t*)pThis->ComboOptions[index]->label, TRUE);
    }
  }
  else
  {
    ...
    GL_SetFont(GL_FONT_BIG);
    GL_SetTextColor(GL_Black);
    GL_DisplayAdjStringLine( (uint8_t)(objCoordinates.MinY), (uint16_t)(objCoordinates.MaxX-3), "+", TRUE);
#endif
    GL_ComboBoxGrp_TypeDef* pTmp = (GL_ComboBoxGrp_TypeDef*)(pThis->PrimaryComboOpt->objPTR);
    for (; index < pTmp->ComboOptionCount-1 && pTmp->ComboOptions[index]->IsActive == FALSE; index++)
    {}
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetCheckboxVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
#ifndef USE_2D_OBJECTS
  uint8_t* ptrBitmap;
#endif
  ...
  else
  {
    ...
    GL_DrawFilledRectangle((uint16_t)(objCoordinates.MaxX-1), 
                           ...
                           (uint8_t)(objCoordinates.MinY+1), GL_White);
    GL_SetTextColor(GL_Black);
    GL_DisplayAdjStringLine( (uint8_t)(objCoordinates.MaxY)-19, (uint16_t)(objCoordinates.MaxX-2), "X", TRUE);
#endif
  }
#ifndef USE_2D_OBJECTS
  GL_DrawButtonBMP( (uint16_t)(objCoordinates.MaxX),
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetIconVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetSlidebarVisible(GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates)
{
#ifndef USE_2D_OBJECTS
  uint8_t* ptrBmpLeft;
  ...
  if ( pThis->Control_Visible != TRUE )
  {
    pThis->Control_Visible = TRUE;
    CursorDraw(Cursor->X, Cursor->Y, CUR_DRAW_BEH);
    if (pThis->Direction == GL_HORIZONTAL)
    {
      SlidebarCursorPreDraw(pTmp, FALSE);
    }
  }
  ...
  {
    SlidebarCursorPreDraw(pTmp, FALSE);
    SlidebarCursorPreDraw(pTmp, TRUE);
  }
  if (pThis->Direction == GL_HORIZONTAL)
  {
#ifndef USE_2D_OBJECTS
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetHistogramVisible( GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates )
{
  uint32_t index = 0;
  uint8_t x_step = 0;
  ...
  GL_DisplayAdjStringLine( (uint16_t)(base_y + 6), max_x + 5, "0", TRUE );
  GL_DisplayAdjStringLine( offset_y - 5, offset_x + HIST_MARGIN_LENGTH - 9, "0", TRUE );
  ...
  for (index = 0; index < (pThis->n_points); index++)
  {
    ...
    if (pThis->n_points <= 15)
    {
      ...
      GL_DisplayAdjStringLine( (uint16_t)base_y + 6, max_x + 6, (uint8_t*) value, TRUE );
    }
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetGraphChartVisible( GL_PageControls_TypeDef* pTmp, GL_Coordinate_TypeDef objCoordinates )
{
  uint32_t index = 0;
  ...
  GL_DisplayAdjStringLine( (uint16_t)(base_y + 6), (uint16_t)(max_x + 5), "0", TRUE ); /* min X value*/
  GL_DisplayAdjStringLine( (uint16_t)(offset_y - 5), (uint16_t)(offset_x + GRAPH_MARGIN_LENGTH - 9), "0", TRUE ); /* min Y value*/

  if (pThis->Background == TRUE)
  {
  ...
  for (index = 0; index < (pThis->n_points); index++)
  {
    ...
    {
      sprintf((char*)value, "%d", index + 1);
      GL_DisplayAdjStringLine( (uint16_t)(base_y + 6), (uint16_t)(max_x + 6), (uint8_t*) value, TRUE );
      GL_SetTextColor(GL_Grey);
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus SetGraphChartPoints( GL_Page_TypeDef* pPage, uint16_t ID, int16_t data_points[], uint8_t n_points )
{
  uint32_t index = 0;
  if (!pPage)
  {
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus SetHistogramPoints( GL_Page_TypeDef* pPage, uint16_t ID, int16_t data_points[], uint8_t n_points )
{
  uint32_t index = 0;
  if (!pPage)
  {
...
/**
  ...
  * @retval None
  */
static void SlidebarCursorPreDraw(GL_PageControls_TypeDef* pControl, bool Draw)
{
...
/**
  ...
  *            - FALSE: the object is not Hit
  *            - TRUE: the object has been Hit
  *            - GL_NULL represent that no object are there with that ID
  * @param  *pPage: pointer to the Page structure
  * @param  ID: Object Identifier
  * @retval bool - FALSE, TRUE
  */
bool GetObjStatus(GL_Page_TypeDef* pPage, uint16_t ID)
{
  uint32_t index = 0;
  ...
  while ( index < pPage->ControlCount ) /* search for the required combobox */
  {
    if (pPage->PageControls[index]->objType == GL_COMBOBOX)
    {
      ...
      if ( pTmp->ID == ID )
      {
        ...
        {
          if (pTmp->ComboOptions[combobox_index]->IsActive == TRUE)
          {
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus ResetComboOptionActive(GL_Page_TypeDef* pPage, uint16_t ID)
{
  uint32_t index = 0, combobox_index = 0;
      ...
      if (pPage->PageControls[index]->objType == GL_COMBOBOX)
      {
        ...
        if ( pTmp->ID == ID )
        {
          while ( combobox_index < pTmp->ComboOptionCount )
          {
            if (combobox_index == 0)
            {
              pTmp->ComboOptions[combobox_index]->IsActive = TRUE;
            }
            else
            {
              pTmp->ComboOptions[combobox_index]->IsActive = FALSE;
            }
            combobox_index++;
          }
          return SUCCESS;
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus SetComboOptionLabel(GL_Page_TypeDef* pPage, uint16_t ID, const uint8_t* label)
{
  uint32_t index = 0, combobox_index = 0;
  if (!pPage)
  {
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus SetIconImage(GL_Page_TypeDef* pPage, uint16_t ID, const uint8_t* pImage, uint16_t Width, uint8_t Height)
{
  uint32_t index = 0;
  if (!pPage)
  {
...
/**
  ...
  * @param  *pPage: Pointer to Page Structure
  * @param  bVal: TRUE Enable / FALSE Disable (Hide) the Page.
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
static ErrorStatus SetPage(GL_Page_TypeDef* pPage, bool bVal)
{
  if (!pPage)
  {
    return ERROR;
...
/**
  ...
  * @param  *pPage: Pointer to Page Structure
  * @param  bVal: TRUE Show / FALSE Hide the Page.
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus ShowPage(GL_Page_TypeDef* pPage, bool bVal)
{
  uint32_t i = 0;
  if (!pPage)
  {
...
/**
  ...
  * @retval ErrorStatus - SUCCESS if successful, ERROR otherwise
  */
ErrorStatus RefreshPageControl( GL_Page_TypeDef* pPage, uint16_t ID)
{
  uint32_t index = 0;
...
{
  ShowPage( pPageOld, FALSE );
  ShowPage( pPageNew, TRUE );
}
...
static void CallPreEvents(GL_PageControls_TypeDef* pControl)
{
  ...
  switch (pControl->objType)
  {
    case GL_BUTTON:
      ...
      ((GL_Button_TypeDef*)(pTmp))->isObjectTouched = TRUE;
      pControl->SetObjVisible(pControl, pControl->objCoordinates);
      while (index < 800000)
        index++;
      ((GL_Button_TypeDef*)(pTmp))->isObjectTouched = FALSE;
      pControl->SetObjVisible(pControl, pControl->objCoordinates);
      break;
    case GL_CHECKBOX:
      pTmp = (GL_Checkbox_TypeDef*)(pControl->objPTR);
      if ( ((GL_Checkbox_TypeDef*)(pTmp))->IsChecked == TRUE )
        ((GL_Checkbox_TypeDef*)(pTmp))->IsChecked = FALSE;
      else
        ((GL_Checkbox_TypeDef*)(pTmp))->IsChecked = TRUE;
      pControl->SetObjVisible(pControl, pControl->objCoordinates);
      break;
    case GL_SWITCH:
      pTmp = (GL_Switch_TypeDef*)(pControl->objPTR);
      if ( ((GL_Switch_TypeDef*)(pTmp))->isObjectTouched == TRUE )
        ((GL_Switch_TypeDef*)(pTmp))->isObjectTouched = FALSE;
      else
        ((GL_Switch_TypeDef*)(pTmp))->isObjectTouched = TRUE;
      pControl->SetObjVisible(pControl, pControl->objCoordinates);
      break;
    case GL_RADIO_BUTTON:
      ...
      if ( ((GL_RadioOption_TypeDef*)(pTmp))->IsChecked == FALSE )
      {
        for (index = 0; index < pTmpGrp->RadioOptionCount; index++)
        {
          ( (GL_RadioOption_TypeDef*)(pTmpGrp->RadioOptions[index]->objPTR))->IsChecked = FALSE;
        }
        ((GL_RadioOption_TypeDef*)(pTmp))->IsChecked = TRUE;
        for (index = 0; index < (pTmpGrp->RadioOptionCount); index++)
        {
    ...
    case GL_COMBOBOX:
      ...
      if (((GL_ComboBoxGrp_TypeDef*)(pTmpComboGrp))->Secondary == FALSE)
      {
#ifdef USE_2D_OBJECTS
        GL_SetTextColor(GL_Grey);
        GL_DisplayAdjStringLine( (uint8_t)(pControl->objCoordinates.MinY-1), (uint16_t)(pControl->objCoordinates.MaxX-1), "-", TRUE);
        GL_DisplayAdjStringLine( (uint8_t)(pControl->objCoordinates.MinY-1), (uint16_t)(pControl->objCoordinates.MaxX-4), "-", TRUE);
        GL_Delay(20);
#endif
        for (index = 0; index < ((GL_ComboBoxGrp_TypeDef*)(pTmpComboGrp))->ComboOptionCount; index++)
        {
          if ( ((GL_ComboBoxGrp_TypeDef*)(pTmpComboGrp))->ComboOptions[index]->IsActive == TRUE )
          {
            active_index = index;
          }
          ((GL_ComboBoxGrp_TypeDef*)(pTmpComboGrp))->ComboOptions[index]->IsActive = FALSE;
        }
        if (active_index == 0)
          pTmpComboGrp->ComboOptions[active_index]->IsActive = TRUE;
        if (active_index > 0)
          pTmpComboGrp->ComboOptions[active_index-1]->IsActive = TRUE;
        pControl->SetObjVisible(pControl, pControl->objCoordinates);
      }
      else
      {
        ...
        {
          if ( pTmpComboGrp2->ComboOptions[index]->IsActive == TRUE )
          {
            active_index = index;
          }
          pTmpComboGrp2->ComboOptions[index]->IsActive = FALSE;
        }
    
        if ( active_index == pTmpComboGrp2->ComboOptionCount - 1 )
          pTmpComboGrp2->ComboOptions[active_index]->IsActive = TRUE;
        else if ( active_index < pTmpComboGrp2->ComboOptionCount - 1 )
          pTmpComboGrp2->ComboOptions[active_index+1]->IsActive = TRUE;
...
void ProcessInputData(void)
{
  ...
  if ( touch_done || joy_done )
  {
    ...
    else if ((vu8_gTouchEnable == 1) && (vu8_gSleepState == 0))
    {
      ...
      {
        if ( PagesList[p_index]->Page_Active == TRUE )
        {
...
static void CallEvent(GL_PageControls_TypeDef* pControl)
{
  ...
  switch (pControl->objType)
  {
    ...
    case GL_COMBOBOX:
      ...
      if (((GL_ComboBoxGrp_TypeDef*)(pTmp))->Secondary == FALSE )
      {
        for (; index < ((GL_ComboBoxGrp_TypeDef*)(pTmp))->ComboOptionCount-1 && ((GL_ComboBoxGrp_TypeDef*)(pTmp))->ComboOptions[index]->IsActive == FALSE; index++)
        {}
      ...
      else
      {
        ...
        for (; index < pPrimaryOption->ComboOptionCount-1 && pPrimaryOption->ComboOptions[index]->IsActive == FALSE; index++)
        {}
