...
ErrorStatus SetIconImage(GL_Page_TypeDef* pPage, uint16_t ID,
...
ErrorStatus SetHistogramPoints( GL_Page_TypeDef* pPage, uint16_t ID,
                                 int16_t data_points[], uint8_t n_points );

/* Graph handler **************************************************************/                                        
GL_PageControls_TypeDef* NewGraphChart (uint16_t ID, const uint8_t* labelX,
                                        const uint8_t* labelY, int16_t data_points[],
                                        uint8_t n_points, bool Background );

ErrorStatus SetGraphChartPoints( GL_Page_TypeDef* pPage, uint16_t ID,
                                  int16_t data_points[], uint8_t n_points );
...
ErrorStatus AddPageControlObj (uint16_t PosX, uint16_t PosY,
                                GL_PageControls_TypeDef* objPTR,
                                GL_Page_TypeDef* pagePTR);
                                
ErrorStatus DestroyPageControl ( GL_Page_TypeDef* pPage, uint16_t ID );

ErrorStatus DestroyPage (GL_Page_TypeDef *pThis);

ErrorStatus ShowPage(GL_Page_TypeDef* pThis, bool bVal);
...
bool GetObjStatus(GL_Page_TypeDef* pThis, uint16_t ID);
